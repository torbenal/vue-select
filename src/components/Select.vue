...
<template>
  <div :dir="dir" class="v-select" :class="stateClasses">
    ...
    <div :id="`vs${uid}__combobox`" ref="toggle" @mousedown.self="toggleDropdown($event)" class="vs__dropdown-toggle" role="combobox" :aria-expanded="dropdownOpen.toString()" :aria-owns="`vs${uid}__listbox`" aria-label="Search for option">
